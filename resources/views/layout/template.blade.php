  ...
  <body>
    <nav class="navbar navbar-expand-lg navbar-light bg-dark" style="height: 60pt" style="color: white">
        <div class="container-fluid">
          <p  class="mt-3" style="padding-left:5pt"><img src="/img/KSGI.png"  alt="gambar" width="78" height="78"></p>
          <p class="nav-link mt-2" href="{{ route('Produks') }}" style="color: white">KASOGI STORE</p>
          <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
            <div class="navbar-nav" style="padding-left: 150px">
              <a class="nav-link" href="{{ route('Produks') }}" style="color: white">Card</a>
              <a class="nav-link" href="{{ route('Produk') }}" style="color: white">Prodak</a>
